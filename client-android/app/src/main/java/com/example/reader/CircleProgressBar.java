...
public class CircleProgressBar extends View {
  ...
  private int textSize = 90;         /*进度文字大小*/
  private float progress = 0f;           /*进度,以百分比显示*/
  private float dp = (float)6;        /*像素*/
  private String progressString = ""; //进度文字
  ...
  protected void onDraw(Canvas canvas) {
     ...
     * 绘制进度文字
     */
    canvas.drawText(progressString,0,textSize/3,textPaint);
  }

  void progressUpdata(String str, int sum, int progress){
    this.progress = (float)(progress) / sum;
